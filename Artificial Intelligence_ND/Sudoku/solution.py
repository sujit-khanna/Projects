...
def naked_twins(values):
    ...
    for unit in unitlist:
        # Find all instances
        box_inst = [box for box in unit if len(values[box]) == 2]
        # All combinations
        all_twins = [list(pair) for pair in itertools.combinations(box_inst, 2)]
...
def reduce_puzzle(values):
    ...
    """
    "Include Diagonal Constraints in this section"
